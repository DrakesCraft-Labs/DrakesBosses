package cl.drakescraft.bosses.integrations;
...
/**
 * Optional bridge to DiosesDrakes. Reflection deliberately keeps DrakesBosses loadable when the
...
public final class DiosesDrakesBossBridge {
    ...
    public DiosesDrakesBossBridge(DrakesBosses plugin) {
        this.plugin = plugin;
    }
