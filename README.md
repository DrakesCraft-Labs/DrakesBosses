...
- **License**: GPL-3.0 / MIT.
- **Source Code**: [GitHub Repository](https://github.com/DrakesCraft-Labs/DrakesBosses)
- **Support & Issues**: [GitHub Issues](https://github.com/DrakesCraft-Labs/DrakesBosses/issues) | [Discord](https://discord.gg/rR7FbfCt9Y)
